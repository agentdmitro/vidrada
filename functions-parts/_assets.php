...
function my_assets()
{
    ...
    wp_enqueue_script('gsap-js', get_stylesheet_directory_uri() . '/build/js/libs/gsap.js');
    wp_enqueue_script('ScrollMagic-js', get_stylesheet_directory_uri() . '/build/js/libs/ScrollMagic.js');
    wp_enqueue_script('ScrollTrigger-js', get_stylesheet_directory_uri() . '/build/js/libs/ScrollTrigger.js');
